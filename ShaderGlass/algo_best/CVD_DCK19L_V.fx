...
void PS_DCK19L(float4 vpos : SV_Position, float2 texcoord : TEXCOORD0, out float4 fragColor : SV_Target)
{
    ...
    //----------------------------------
    // Adaptive Luminance Preserve (new in DCK19L)
    //----------------------------------
...
technique DCK19L_ColorCorrection
{
    pass
    {
